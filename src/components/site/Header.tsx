        ...
        <div className="flex w-full items-center gap-2 md:flex-1 md:gap-4">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="flex gap-2 rounded-full outline-none focus:outline-none focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0 border-2 border-[#3b9c45] text-foreground font-semibold px-3 md:px-4 hover:bg-[#3b9c45]/10 shrink-0">
